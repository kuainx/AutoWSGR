...
SHIP_LEVEL_CROP: dict[int, tuple[float, float, float, float]] = {
    0: (0.0583, 0.5600, 0.1708, 0.5900),
    1: (0.1729, 0.5600, 0.2854, 0.5900),
    2: (0.2875, 0.5600, 0.4000, 0.5900),
    3: (0.4021, 0.5600, 0.5146, 0.5900),
    4: (0.5167, 0.5600, 0.6292, 0.5900),
    5: (0.6313, 0.5600, 0.7438, 0.5900),
}
