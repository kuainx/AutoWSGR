...
daily_automation:
  ...
  stop_max_ship: False # 捞满500船时自动停止出击
...
- autowsgr.game.game_operation.repair_by_bath: 用于浴场修理
- autowsgr.game.get_game_info.detect_resources: 用于检查资源余量
- autowsgr.game.game_operation.set_auto_supply: 用于设置自动补给
- autowsgr.game.game_operation.supply: 用于补给舰船
- autowsgr.game.game_operation.destroy_ship: 用于解装舰船
- autowsgr.game.game_operation.set_support: 用于设置战役支援开启状态
